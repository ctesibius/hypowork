...
// Default dev stack uses Nest; legacy Express is `pnpm dev:server:express` (see root package.json).
const serverScript = mode === "watch" ? "dev" : "dev:once";
const child = spawn(
  pnpmBin,
  ["--filter", "@hypowork/server-nest", serverScript, ...forwardedArgs],
