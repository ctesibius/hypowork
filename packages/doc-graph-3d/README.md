# @hypowork/doc-graph-3d

Company **document library graph** styling presets aligned with **3d-force-graph** examples (`example/*` in the upstream repo).

- **Engine:** [`3d-force-graph`](https://github.com/vasturiano/3d-force-graph) (MIT, Vasco Asturiano) — see `LICENSE-3d-force-graph.txt`.
