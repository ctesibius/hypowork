 ...
 * channel.
 *
 * The Hypowork plugin runtime uses JSON-RPC 2.0 over stdio to communicate
 ...
 * we use strings (UUIDs or monotonic counters) for all Hypowork messages.
 */
...
/**
 * Hypowork plugin-specific error codes.
 *
...
export interface InitializeParams {
  ...
  instanceInfo: {
    /** UUID of this Hypowork instance. */
    instanceId: string;
    /** Semver version of the running Hypowork host. */
    hostVersion: string;
  };
  /** Host API version. */
  apiVersion: number;
