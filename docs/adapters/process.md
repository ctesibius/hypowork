...
- Running a Python script that calls the Hypowork API
...
1. Hypowork spawns the configured command as a child process
2. Standard Hypowork environment variables are injected (`PAPERCLIP_AGENT_ID`, `PAPERCLIP_API_KEY`, etc.)
...
The script can use the injected environment variables to authenticate with the Hypowork API and perform work.
