...
import { OrgEmployeeDirectory } from "../components/OrgEmployeeDirectory";
...
export function OrgChart() {
  ...
  if (orgLoading) {
    return (
      <div className="space-y-6">
        <OrgEmployeeDirectory companyId={selectedCompanyId} />
  ...
  return (
    <div className="space-y-6 w-full">
      ...
      <div
      ref={containerRef}
      className="w-full h-[calc(100dvh-14rem)] min-h-[280px] overflow-hidden relative bg-muted/20 border border-border rounded-lg"
