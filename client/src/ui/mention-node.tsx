...
export type MentionComboItem = { key: string; text: string; keywords?: string[] };

/** Same shape as server / markdown-kit standalone document mention `key`. */
...
/** Demo data when not editing a company document (e.g. `/plate-markdown-test`). */
export const PLATE_LINK_PICKER_DEMO_ITEMS: MentionComboItem[] = [
