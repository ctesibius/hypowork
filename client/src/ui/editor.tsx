  ...
  'relative w-full cursor-text select-text overflow-y-auto caret-primary selection:bg-brand/25 focus-visible:outline-none [&_.slate-selection-area]:z-50 [&_.slate-selection-area]:border [&_.slate-selection-area]:border-brand/25 [&_.slate-selection-area]:bg-brand/15',
  {
    ...
    variants: {
      variant: {
        ...
        default: 'h-full',
        demo: 'h-[650px]',
        /** Full-width notes: no centered narrow column (avoids huge side gutters on wide screens). */
        document: 'h-full',
        select: cn(
  ...
  ),
  {
    ...
    variants: {
      ...
      variant: {
        ...
        /** Wider text block; modest gutters only (used for company document full-bleed page). */
        document:
          'size-full px-4 pt-4 pb-72 text-base sm:px-6 md:px-8 lg:px-10 xl:px-12',
