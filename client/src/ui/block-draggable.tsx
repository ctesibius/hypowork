...
function Draggable(props: PlateElementProps) {
  ...
  return (
    ...
    >
      ...
      <div
        ref={nodeRef}
        className="relative z-0 flow-root slate-blockWrapper"
        onContextMenu={(event) =>
          editor
...
const DropLine = React.memo(function DropLine({
  ...
  return (
    <div
      ...
      className={cn(
        'slate-dropLine',
        'pointer-events-none absolute inset-x-0 z-[100]',
        'h-0.5 rounded-full bg-foreground/12',
        'transition-[opacity,transform] duration-150',
        dropLine === 'top' && 'top-0 -translate-y-1/2',
        dropLine === 'bottom' && 'bottom-0 translate-y-1/2',
        className
      )}
    />
  );
