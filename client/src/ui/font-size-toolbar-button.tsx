...
import { usePlateEditorScopeId, useScopedEditorSelector } from './plate-editor-scope';
...
export function FontSizeToolbarButton() {
  ...
  const scopeId = usePlateEditorScopeId();
  const { editor, tf } = useEditorPlugin(FontSizePlugin, scopeId);

  const cursorFontSize = useScopedEditorSelector((editor) => {
    ...
    const blockTuple = editor.api.block();
    const block = blockTuple?.[0] as TElement | undefined;
