...
import { mergeReportingEnvForHeartbeat } from "./reporting-env-merge.js";
...
export function heartbeatService(db: Db) {
  ...
  async function executeRun(runId: string) {
    ...
    mergedConfig = await mergeReportingEnvForHeartbeat(db, agent.companyId, agent, mergedConfig);
