...
This document covers the GitHub and npm setup required for the current Hypowork release model:
...
Do this for every public package that Hypowork publishes.
...
2. revoke any personal automation token that used to publish Hypowork
