...
This is intentionally separate from the normal Hypowork dev image.
...
## Preview the Hypowork app from the PR
...
- Hypowork's embedded PostgreSQL and local storage stay inside the container home volume via `PAPERCLIP_HOME=/home/reviewer/.paperclip-review`.
