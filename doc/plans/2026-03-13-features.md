...
- Team of 3 can use one shared Hypowork instance.
...
Hypowork should manage the **issue → workspace → preview/PR → review handoff** lifecycle, but leave diffs/review/merge to external tools.
...
- A chat plugin can converse without requiring chat to become the core Hypowork product.
...
- **Keep** Hypowork as the board-level control plane.
