...
Hypowork already treats budgets as a core control-plane responsibility:
...
This plan defines the concrete budgeting model Hypowork should implement next.

## Product Goals

Hypowork should let operators:
...
For the next implementation pass, Hypowork should enforce these defaults:
...
Hypowork should separate subscription-included usage from billed spend:
...
Hypowork should have two threshold classes:
...
Hypowork must know that a project is budget-paused and enforce it.
...
Hypowork must also block execution before new work starts.
