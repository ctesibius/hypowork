# Hypowork Skill Tightening Plan
...
- preserve all current Hypowork control-plane capabilities
...
- changing Hypowork API semantics
...
- add at least lightweight eval or scripted scenario coverage for key Hypowork flows
- confirm how adapter/bootstrap layering should load skill content versus references

## Success Criteria

- materially lower first-run input tokens for Hypowork-coordinated agents
